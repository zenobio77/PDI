...
FRAME_THICKNESS = 3
FONT_THICKNESS = 2
MODEL = 'cnn'  # CUDA accelerated (if available) deep-learning pretrained model


# Returns (R, G, B) from name
def name_to_color(name):
    # Take 3 first letters, lower()
...
for filename in os.listdir(UNKNOWN_FACES_DIR):
    ...
    for face_encoding, face_location in zip(encodings, locations):
        ...
        if True in results:  # If at least one is true, get a name of first of found labels
            ...
            # Add found person to the attendance set
            attendance_list.add(match)
...
# Create attendance list txt based on the set of matches
